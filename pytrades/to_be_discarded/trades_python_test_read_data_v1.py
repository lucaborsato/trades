...
def main():
    ...
    example_folder = os.path.join(
        script_folder, "..", "trades_example", "Kepler-9_example"
    )

    # read rv data
    rv_path = os.path.join(example_folder, "obsRV.dat")
    ...
    # read t0 data
    t0b_path = os.path.join(example_folder, "NB2_observations.dat")
    t0b_data = np.genfromtxt(t0b_path)
    n_t0b = t0b_data.shape[0]

    t0c_path = os.path.join(example_folder, "NB3_observations.dat")
    ...
    for inb in range(1, n_body):
        ...
        print(
            "# {:>6s} {:>20s} {:>20s} {:>16s} {:>16s} {:>16s} {:>16s} {:>16s} {:>16s} {:>16s} {:>16s} {:>16s}".format(
                "t0_num",
                "t0_obs",
                "t0_sim",
                "t14_sim",
