...
module settings_module
  ...
  use utils_module,   only: STR_LENGTH
    ...
    Type :: program_settings
        ...
        real(dp) :: precision_criterion = 1.e-3_dp !> The stopping criterion
        ...
        character(STR_LENGTH) :: file_root='trades_PolyChord'  !> The file root for outputs
