...
program main_pik_pso
    ...
    real(dp)::chi_square, reduced_chi_square, lnL, lnprior, ln_c, bic
    integer::sim_id
    ...
    call read_first(cpuid, mass, radius, period, sma, ecc, argp, meanA, inc, longN) ! new versione already set system_parameters and boundaries (physical and user-provided)
...
!   call set_par(mass,radius,period,sma,ecc,argp,meanA,inc,longN,system_parameters,fitting_parameters)
...
!     call set_par(m,R,P,a,e,w,mA,inc,lN,system_parameters,fitting_parameters)
        ...
        call write_summary_nosigma(cpuid, sim_id, 0, system_parameters, fitting_parameters,&
          &chi_square, reduced_chi_square, lnL, lnprior, ln_c, bic)
